...
public class ChessBoardAct extends AppCompatActivity {
    Timer closeTimer;
    Button pause,dice;
    Button dice1, dice2, dice3, dice4, dice5, dice6;
    Button[][] plane;
    int boardWidth;
    Handler handler;
    ImageView map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dice1 = (Button)findViewById(R.id.dice1);
        dice2 = (Button)findViewById(R.id.dice2);
        dice3 = (Button)findViewById(R.id.dice3);
        dice4 = (Button)findViewById(R.id.dice4);
        dice5 = (Button)findViewById(R.id.dice5);
        dice6 = (Button)findViewById(R.id.dice6);
    ...
    public void handleMessage(Message msg){//事件回掉
        switch (msg.what){
            case 1://飞机
            {
                ...
                if(pos!=-2){
                    parent.animMoveTo(parent.plane[color][whichPlane],Game.getChessBoard().map[color][pos][0],Game.getChessBoard().map[color][pos][1]);
                }
                else{//消失
                    parent.animMoveTo(parent.plane[color][whichPlane],Game.getChessBoard().map[color][55][0],Game.getChessBoard().map[color][55][1]);
                }
            }
            break;
            case 2://筛子
            ...
            case 3: //碰撞
            {
                int color=msg.getData().getInt("color");
                int whichPlane=msg.getData().getInt("whichPlane");
                parent.animMoveTo(parent.plane[color][whichPlane],Game.getChessBoard().mapStart[color][whichPlane][0],Game.getChessBoard().mapStart[color][whichPlane][1]);
            }
            break;
            default:
